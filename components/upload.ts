...
export async function uploadToPinata(
  ...
  try {
    ...
    if (fileData instanceof Blob || fileData instanceof File) {
      ...
      fileBlob = new Blob([fileData], { type: fileType || 'application/octet-stream' });
    }
...
export async function uploadJSONToPinata(jsonData: object, fileName: string): Promise<string> {
  try {
